...
<head>
    ...
    <meta name="keywords" content="个人博客,个人博客系统">
    <meta name="description" content="SX博客系统，一个站在java开发之路上的草根程序员个人博客网站。">
            ...
            <div class="slider">
                <div class="bd">
                    <ul>
                        ...
                        <li><a href="#" target="_blank"><img src="/staticimg/temp/banner8.png"></a></li>
                    </ul>
                </div>
                <ol class="hd cl dots">
                    <li>1</li>
...
<footer class="footer mt-20">
    <div class="container-fluid" id="foot">
        <p>Copyright &copy; 2019-2020 www.shixin.top
        </p>
    </div>
</footer>
